    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2 text-center">
                <!-- Title text -->
                <h3>Registration: Enter Information</h3>
            </div>
        </div>
    </div>
    <!-- Container End -->
				...
				<div class="widget personal-info">
					...
					<form action="#">
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="contactphone" name="contactphone" placeholder="Phone Number" required="">
						</div>
						<div class="form-group">
						    <label for="contactsubject">Subject</label>
						    <input type="contactsubject" class="form-control" id="contactsubject" name="contactsubject" placeholder="Subject" required="">
						</div>
						<div class="form-group">
						    <label for="contactmessage">Message</label>
						    <textarea class="form-control" rows="5" cols="50" id="contactmessage" name="contactmessage" placeholder="Message" required=""></textarea>
						</div>
						<!-- Submit button -->
