            ...
            <div class="checkout">
                <div class="row">
                    ...
                    <div class="col-md-12 order-md-1">
                        ...
                        <form action="<?=base_url('welcome/createAccount')?>" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="lastname" value="<?=$custData['lastname'];?>" placeholder="Enter Last Name" required readonly>
                            ...
                            <input class="btn btn-success btn-lg btn-block" type="submit" name="create" value="Create Account">
                        </form>
                      <?php } else{ ?>
