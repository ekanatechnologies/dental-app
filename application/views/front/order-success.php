...
<META http-equiv="refresh" content="3;URL=https://ekanatechnologies.in/dev/dental/"> 
            ...
            <div class="tab-pane fade show active" id="nav-activity" role="tabpanel" aria-labelledby="nav-activity-tab">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                        ...
                        <?php if(!empty($result)){ ?>
                            <div class="col-md-12">
                                <div class="alert alert-success" id='payment-message'>Your order has been placed successfully and your transaction id is : <?=$result;?></div>
                            </div>

                            <!-- Order status & shipping info -->
                            <div class="row col-lg-12 ord-addr-info">
                                <div class="hdr">Order Info</div><br><br>
                                <p><b>Reference ID:</b> #<?php echo $order['id']; ?></p><br>
                                <p><b>Total:</b> <?php echo '$'.$order['grand_total'].' USD'; ?></p><br>
                                <p><b>Placed On:</b> <?php echo $order['created']; ?></p><br>
                                <p><b>Buyer Name:</b> <?php echo $order['name']; ?></p><br>
                                <p><b>Email:</b> <?php echo $order['email']; ?></p><br>
                                <p><b>Phone:</b> <?php echo $order['phone']; ?></p><br>
                            </div>
