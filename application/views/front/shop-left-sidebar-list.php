	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
						...
						<div class="col-md-6">
							<div class="view">
								...
								<ul class="list-inline view-switcher">
									...
									<li class="list-inline-item">
										<a class="text-info" href="<?php echo base_url('shop-left-sidebar-list/1/cat');?>" onclick="event.preventDefault();"><i class="fa fa-reorder"></i></a>
									</li>
								</ul>
							</div>
						</div>
                ...
                ?>
				<div class="product-grid-list1" id="myTabContent-buy_sell_list" data-url="<?php echo base_url('welcome/product_filter_buy_sell_list/' . $page_id);?>" >
