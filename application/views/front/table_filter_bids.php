			...
			$sr=1; foreach ($users as $key => $value) { 
				...
				<tr>
					...
					<td class="product-details">
						...
						<span class="add-id"><strong>Price:</strong> <?=$value['price']?></span>
						<span class="add-id"><strong>Bid:</strong> <?=$value['bid_price']?></span>
						...
						<div class="">
							<ul class="list-inline justify-content-center">
								<li class="list-inline-item">
									<a data-toggle="tooltip" data-placement="top" title="View" class="view" href="<?= base_url();?>viewad/<?= $service_name; ?>/<?= $listname; ?>/<?= $value['id'];?>">
										<i class="fa fa-eye"></i>
									</a>
								</li>
								<!-- <li class="list-inline-item">
