					...
					<nav class="navbar navbar-expand-lg">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<ul class="navbar-nav ml-auto mt-10">
								<li class="nav-item">
									<a class="nav-link btn postcolor"  href="<?= base_url('Welcome/postads'); ?>"><i class="far fa-plus-square"></i>&nbsp;Post ads</a>
								</li>
								&nbsp;
								<?php if(is_logged_in()) { ?>
								...
								&nbsp;
								<?php } else { ?>
									<a href="#appointment" data-toggle="modal" data-target="#exampleModalCenter" class="nav-link btn signincolor"><span class="d-none d-md-inline"></span>Sign In</a>
									<?php }	?>
							</ul>
					</div>
				</nav>				 
