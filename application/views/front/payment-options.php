	                ...
	                <div class="row">                                       
	                    ...
	                    <div class="col-md-8 order-md-1">
	                        <!-- <h4 class="mb-3">Payment Options</h4> -->
	                         <a class="btn btn-primary btn-block" style="color: #fff !important;">Paypal</a>
	                         <a href="<?=base_url('welcome/braintree_custom_integration_payment')?>" class="btn btn-success btn-block" style="color: #fff !important;">Create Account & Pay</a>
	                         <a class="btn btn-success btn-block" style="color: #fff !important;">Other</a>
	                                             
	                         <a href="<?=base_url('welcome/braintree_3D_secure_payment')?>">braintree_3D_secure_payment</a>

	                         <a href="<?=base_url('welcome/braintree_custom_integration_payment');?>">braintree_custom_integration_payment</a>

	                         <a href="<?=base_url('welcome/braintree_dropin_payment')?>">braintree_dropin_payment</a>

	                         <a href="<?=base_url('welcome/braintree_dropin_with_3d_secure_payment')?>">braintree_dropin_with_3d_secure_payment</a>

	                         <a href="<?=base_url('welcome/braintree_hosted_fields_payment')?>">braintree_hosted_fields_payment</a>

	                         <a href="<?=base_url('welcome/braintree_hosted_fields_with_3d_secure_payment')?>">braintree_hosted_fields_with_3d_secure_payment</a>

	                         <a href="<?=base_url('welcome/braintree_hosted_fields_with_style_payment')?>">braintree_hosted_fields_with_style_payment</a>
