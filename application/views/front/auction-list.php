	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
							...
							<div class="view">
								...
								<ul class="list-inline view-switcher">
									<li class="list-inline-item">
										<a href="<?php echo base_url('auction');?>" ><i class="fa fa-th-large"></i></a>
									</li>
									<li class="list-inline-item">
										<a class="text-info" href="<?php echo base_url('auction-list');?>" onclick="event.preventDefault();"><i class="fa fa-reorder"></i></a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="product-grid-list1" id="myTabContent-auction_list" data-url="<?php echo base_url('welcome/product_filter_auction_list/' . $page_id);?>" >
