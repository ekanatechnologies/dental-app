	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
							...
							<div class="view">
								...
								<ul class="list-inline view-switcher">
									<li class="list-inline-item">
										<a href="<?php echo base_url('marketplace');?>" onclick="event.preventDefault();" ><i class="fa fa-th-large"></i></a>
									</li>
									<li class="list-inline-item">
										<a href="<?php echo base_url('marketplace-list');?>" class="text-info"><i class="fa fa-reorder"></i></a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="product-grid-list" id="myTabContent-marketplace_list" data-url=<?php echo base_url('welcome/product_filter_marketplace_list/' . $page_id);?>>
