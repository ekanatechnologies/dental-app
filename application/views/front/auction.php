		...
		<div class="row">
			...
			<div class="col-md-9">
							...
							<div class="view">
								...
								<ul class="list-inline view-switcher">
									<li class="list-inline-item">
										<a href="<?php echo base_url('auction');?>" onclick="event.preventDefault();" class="text-info"><i class="fa fa-th-large"></i></a>
									</li>
									<li class="list-inline-item">
										<a href="<?php echo base_url('auction-list');?>"><i class="fa fa-reorder"></i></a>
									</li>
								</ul>
							</div>
						</div>
				...
				<?php
                    ...
                    ?>
				<div class="product-grid-list" id="myTabContent-auction" data-url=<?php echo base_url('welcome/product_filter_auction/' . $page_id);?>>		
				</div>			  
			</div>
		</div>
	</div>
