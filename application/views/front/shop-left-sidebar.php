	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="search-result bg-gray">
					<h2>Results For "Buy/Sell"</h2>
					<p><?php
                            if(!empty($ads)){                                
                                foreach ($ads as $ad) {
                                	if ($ad['ad_name']=='Buy') {
                                		echo $ad['ad_name'].' ('. $ad['count'].')';
                                	}
                                	echo ' ';
                                	if ($ad['ad_name']=='Sell') {
                                		echo $ad['ad_name'].' ('. $ad['count'].')';
		...
		<div class="row">
					...
					<div class="widget product-shorting">
						...
						<div class="form-check" >
							<span class="custom-checkbox city_filter">
                                <input type="checkbox" id="compositions_color<?php echo $i;?>" value="<?php echo $city['city'];?>" class="compositions">
                                <label for="compositions_color<?php echo $i;?>"><?php echo $city['city'].' ('. $city['count'].')';?></label>
			...
			<div class="col-md-9">
							...
							<div class="view">
								...
								<ul class="list-inline view-switcher">
									<li class="list-inline-item">
										<a href="<?php echo base_url('shop-left-sidebar/1/cat');?>" onclick="event.preventDefault();" class="text-info"><i class="fa fa-th-large"></i></a>
									</li>
									<li class="list-inline-item">
										<a href="<?php echo base_url('shop-left-sidebar-list/1/cat');?>"><i class="fa fa-reorder"></i></a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="product-grid-list" id="myTabContent1" data-url=<?php echo base_url('welcome/product_filter/' . $page_id);?>>
