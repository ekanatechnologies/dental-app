				...
				<div class="sidebar">
					...
					<div class="widget user-dashboard-profile">
						...
						<div class="profile-thumb">
							<img src="<?php echo base_url('assets/frontend/') ?>images/user/user-thumb.jpg" alt="" class="rounded-circle">
						</div>
						<!-- User Name -->
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body text-center">
								<img src="<?php echo base_url('assets/frontend/') ?>images/account/Account1.png" class="img-fluid mb-2" alt="">
					...
					<tbody>
						<tr>
							...
							<td class="product-thumb">
								<img width="80px" height="auto" src="<?php echo base_url('assets/frontend/') ?>images/products/products-1.jpg" alt="image description"></td>
							...
							<tr>
								...
								<td class="product-thumb">
									<img width="80px" height="auto" src="<?php echo base_url('assets/frontend/') ?>images/products/products-2.jpg" alt="image description"></td>
									<td class="product-details">
								...
								<tr>
									...
									<td class="product-thumb">
										<img width="80px" height="auto" src="<?php echo base_url('assets/frontend/') ?>images/products/products-3.jpg" alt="image description"></td>
										<td class="product-details">
											<h3 class="title">Macbook Pro 15inch</h3>
											<span class="add-id"><strong>Ad ID:</strong> ng3D5hAMHPajQrM</span>
											<span><strong>Posted on: </strong><time>Jun 27, 2017</time> </span>
									...
									<tr>
										...
										<td class="product-thumb">
											<img width="80px" height="auto" src="<?php echo base_url('assets/frontend/') ?>images/products/products-4.jpg" alt="image description"></td>
											<td class="product-details">
												<h3 class="title">Macbook Pro 15inch</h3>
												<span class="add-id"><strong>Ad ID:</strong> ng3D5hAMHPajQrM</span>
												<span><strong>Posted on: </strong><time>Jun 27, 2017</time> </span>
