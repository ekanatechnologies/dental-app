						...
						<div class="sidebar">
							...
							<div class="widget user-dashboard-profile">
								...
								<div class="profile-thumb">
									...
									<?php }else{ ?>
									<img src="<?=base_url('assets/frontend/images/user/'); ?>Sample_User_Icon.png" alt="user" class="rounded-circle">
								    <?php } ?>
								</div>
								<!-- User Name -->
				...
				<div class="widget personal-info">
					...
					<?php echo form_open_multipart('Welcome/editprofile');?> 
						...
						<div class="form-group">
						    ...
						    <input type="text" name="name" class="form-control" id="name" placeholder="First Name" value="<?= user_details()->name; ?>">
						</div>
						<div class="form-group">
						    <label for="phone">Last Name</label>
						    <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Last Name" value="<?= user_details()->lastname; ?>">
						</div>
						<!-- Last Name -->
						<div class="form-group">
						    <label for="email">Email</label>
						    <input type="email" name="email" class="form-control" id="email" placeholder="Email Address" value="<?= user_details()->email; ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group choose-file">
						    ...
						    <input type="hidden" name="image" class="form-control" id="image" value="<?= user_details()->image; ?>"> 
						<!-- Submit button -->
