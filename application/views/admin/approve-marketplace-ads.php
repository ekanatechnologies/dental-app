            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Marketplace ads list</h5>
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr> 
                                        ...
                                        ?>
                                        <td><a href="<?= base_url();?>viewad/<?= $service_name; ?>/<?= $listname; ?>/<?= $row->id;?>" type="button" class="mb-2 mr-2 btn btn-primary active" >View</a>
                                        </td>
                                        <td> 
                                            ...
                                            <?php } ?> 
                                            <a href="ads_delete/<?=$row->id?>"   class="mb-2 mr-2 btn btn-danger active">Delete</a>
                                        </td>
                                    </tr>
                                    <?php $sr++; } ?> 
                                </tbody>
