                            ...
                            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><a href="<?php echo site_url("Manufacturer/update/$row->id")?>" type="button" class="mb-2 mr-2 btn btn-primary active" >Update</a><a href="<?php echo site_url("Manufacturer/delete/$row->id")?>" type="button" class="mb-2 mr-2 btn btn-danger active">Delete</a></td>
                                    </tr>
                                    <?php $sr++; } ?>
                                     <?php } ?> 
                                </tbody>
