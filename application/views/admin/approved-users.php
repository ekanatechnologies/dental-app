                ...
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Approved Users list
                            <div class="page-title-subheading">This is a list of users
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Approved users list</h5>
                                    ...
                                    <tr>
                                        ...
                                        if ($status == '1') {?> 
                                            <a href="<?php echo base_url();?>Users/update_user_status?id=<?php echo $row->id;?>&svalue=1" class="mb-2 mr-2 btn btn-success">Approved</a> &nbsp;
                                             <a href="<?php echo base_url();?>Users/getUserActivity/<?php echo $row->id;?>" class="mb-2 mr-2 btn btn-primary">View</a> 
                                        <?php } else {?> 
