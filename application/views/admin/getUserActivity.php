            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Get Users Activity List
                            <div class="page-title-subheading">This is a list of users activity
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Users activity list</h5>
                                    ...
                                    <tr>
                                        ...
                                        if ($status == '1') {?> 
                                            <a href="<?php echo base_url();?>Users/update_user_status?id=<?php echo $row->id;?>&svalue=1" class="mb-2 mr-2 btn btn-success">Approved</a> &nbsp;
                                             <a href="<?= base_url();?>viewad/<?= $service_name; ?>/<?= $listname; ?>/<?= $row->id;?>" class="mb-2 mr-2 btn btn-primary">View</a> 
                                        <?php } else {?> 
                                             <a href="<?php echo base_url();?>Users/update_user_status?id=<?php echo $row->id;?>&svalue=0" class="mb-2 mr-2 btn btn-danger">Rejected</a>
                                        <?php } ?> 
                                        <a href="<?php echo base_url();?>Users/ads_delete/<?=$row->id?>" class="mb-2 mr-2 btn btn-danger active">Delete</a>
                                    </td>
                                    </tr>
                                    <?php $sr++;} ?>                                    
                                </tbody>
