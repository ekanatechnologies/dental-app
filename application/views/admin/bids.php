            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Bids
                            <div class="page-title-subheading">Manage Bids
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Manage Bids</h5> 
                             <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <!-- <td><?= $row['created']; ?></td>  -->
                                        <td><a href="<?=base_url('admin/view-bid-list');?>/<?= $row['user_id']; ?>" type="button" class="mb-2 mr-2 btn btn-primary active" >View</a>
