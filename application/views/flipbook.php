...
<head>
    ...
    <link rel="stylesheet" href='<?php echo base_url()?>pdfjs/viewer.css'/>
    <link rel="stylesheet" href="<?php echo base_url()?>pdf-flip.css"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
            ...
            height: 100%;
            z-index: 9999;
            background: url(<?php echo base_url()?>pics/loader.gif) center no-repeat #fff;
        }
    </style>
</head>
...
<script src="<?php echo base_url()?>pdfjs/compatibility.js"></script>
<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="<?php echo base_url()?>pdfjs/locale/locale.properties"/>
<script src="https://code.jquery.com/jquery-2.1.4.min.js"></script>
<script src="<?php echo base_url()?>turnjs/turn.min.js"></script>
<script src="<?php echo base_url()?>turnjs/zoom.min.js"></script>
<script src="<?php echo base_url()?>pdfjs/l10n.js"></script>
<script src="<?php echo base_url()?>pdfjs/build/pdf.js"></script>
<script src="<?php echo base_url()?>pdfjs/debugger.js"></script>



<script type="text/javascript">
    var DEFAULT_URL = '<?php echo base_url() ?>/uploads/flipbooks/<?php echo $flipbook->files;  ?>';
    PDFJS.workerSrc = '<?php echo base_url() ?>pdfjs/build/pdf.worker.js';

</script>
<script type="text/javascript" src="<?php echo base_url()?>pdfjs/viewer.js"></script>
<script src="<?php echo base_url()?>pdf-flip.js?v=1.1.1.1.1.1"></script>
<script type="text/javascript">
