...
class UserModel extends CI_Model {
	...
	{  
 		...
 		$this->db->select('id,name,first_name,last_name,email,about,mobile_no,address,address_2,state,city,country,image,pincode');
	...
	{  
		...
		if(!empty($res['image'])){
			...
			return base_url('uploads/profiles/'.$res['image']);
