<?php
 ...
 class ChatModel extends CI_Model {
	...
	public function GetReciverChatHistory($receiver_id){
		...
		//SELECT * FROM `chat` WHERE `sender_id`= 4 AND `receiver_id` = 3 OR `sender_id`= 3 AND `receiver_id` = 4

		//$condition= "`sender_id`= 4 AND `receiver_id` = 3 OR `sender_id`= 3 AND `receiver_id` = 4";
